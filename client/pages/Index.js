...
export default function Index() {
    ...
    return (<div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <button onClick={() => setIsTrialModalOpen(true)} className="bg-primary text-primary-foreground px-8 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors text-lg">
                  Começar teste grátis por 14 dias
                </button>
                <button onClick={() => navigate("/login")} className="border-2 border-primary text-primary px-8 py-3 rounded-lg font-semibold hover:bg-primary/5 transition-colors">
                  Fazer Login
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
            {
                ...
                description: "A IA interpreta o que você vende e ajuda a priorizar licitações com mais chance de fazer sentido.",
            },
            {
                icon: Clock,
                title: "Alertas no momento certo",
                description: "Receba oportunidades por e-mail no horário escolhido. Nunca mais perca um edital importante.",
            },
            {
                icon: BarChart3,
                title: "Pipeline de oportunidades",
                description: "Filtre por região, modalidade e valor. Salve favoritas, anote e visualize no mapa.",
            },
        ].map((feature, idx) => (<div key={idx} className="border border-border rounded-lg p-8 hover:shadow-lg transition-shadow">
          ...
          {[
            {
                ...
                description: "Comece com produtos ou serviços que sua empresa oferece. A busca inteligente ajuda a encontrar oportunidades além do termo exato.",
            },
            {
                number: "2",
                title: "Ative o teste e receba alertas",
                description: "Crie sua conta grátis por 14 dias e receba oportunidades por e-mail, com links para o edital ou a página oficial.",
            },
            {
                number: "3",
                title: "Refine para ficar mais certeiro",
                description: "Ajuste regiões, horários, termos e estilo dos e-mails. Use favoritos, notas e exclusões para organizar seu pipeline.",
            },
      ...
      <section className="bg-white py-20">
        ...
        ].map((plan, idx) => (<div key={idx} className={`rounded-lg p-8 text-center relative ${plan.highlight
                ? "bg-primary text-primary-foreground ring-2 ring-primary"
                : "bg-background border-2 border-border"}`}>
                {plan.highlight && (<span className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-primary text-primary-foreground px-3 py-1 rounded-full text-sm font-semibold">
                    Mais vendido
                  </span>)}
          ...
          {[
            {
                ...
                description: "Encontre oportunidades que fazem sentido sem conferir tudo manualmente.",
            },
            {
                icon: "📦",
                title: "Fornecedores",
                description: "Filtre por região, modalidade e valor para agir com foco.",
            },
            {
                icon: "🤝",
                title: "Consultorias",
                description: "Organize oportunidades de clientes com favoritos, notas e comentários.",
            },
            {
                icon: "💼",
                title: "Escritórios",
                description: "Programe alertas para a equipe receber quando pode agir.",
            },
        ].map((audience, idx) => (<div key={idx} className="bg-white rounded-lg p-6 border border-border text-center">
      ...
      <section id="faq" className="bg-white py-20">
        ...
        ].map((faq, idx) => (<details key={idx} className="border border-border rounded-lg p-6 group cursor-pointer">
      ...
      <section className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <button onClick={() => setIsTrialModalOpen(true)} className="bg-primary-foreground text-primary px-8 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition-colors text-lg">
