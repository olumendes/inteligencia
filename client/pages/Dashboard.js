...
import { LogOut, Mail, Calendar, Star, CheckCircle, Settings } from "lucide-react";
export default function Dashboard() {
    ...
    if (error || !userInfo) {
        ...
        <div className="text-center">
          ...
          <button onClick={() => navigate("/login")} className="text-primary hover:text-primary/80 font-semibold">
            Voltar para login
          </button>
        </div>
      </div>);
    ...
    return (<div className="min-h-screen bg-background">
      ...
      <header className="bg-white border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <button onClick={handleLogout} className="flex items-center gap-2 px-4 py-2 text-foreground/70 hover:text-foreground hover:bg-background rounded-lg transition-colors">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg p-6 border border-border">
            ...
            },
            {
                ...
                status: "Aberta",
        ...
        ].map((bid, idx) => (<div key={idx} className="flex items-start justify-between p-4 bg-background rounded-lg hover:bg-primary/5 transition-colors">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold ${bid.status === "Aberta"
        ...
        ].map((stat, idx) => (<div key={idx} className={`rounded-lg p-6 text-center ${stat.color}`}>
